...
TEMP_LOCATION = f"{GCS_BUCKET_NAME}/lab-3/temp"
OUTPUT_Q1_FILE = f"{GCS_BUCKET_NAME}/lab-3/q1_output.txt"
OUTPUT_Q2_FILE = f"{GCS_BUCKET_NAME}/lab-3/q2_output.txt"

INPUT_DATA_FILE = "gs://bdl2022/lines_big.txt"

beam_options = PipelineOptions(
    project="gsoc-wav2vec2",
    job_name="lab-3-assignment",
